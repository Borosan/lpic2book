...
root@server1:~# cd cdroot/
root@server1:~/cdroot# cp ../syslinux-6.03/bios/core/isolinux.bin .
root@server1:~/cdroot# cp /boot/vmlinuz-4.10.0-42-generic .
root@server1:~/cdroot# cp /boot/initrd.img-4.10.0-42-generic .
...
label Ubuntu
      menu label Ubuntu 16.04.3 
      kernel vmlinuz-4.10.0-28-generic 
      append initrd=initrd.img-4.10.0-28-generic root=/dev/sda1
```

```
root@server1:~#cd ..
root@server1:~# mkisofs -o bootcd.iso -b isolinux.bin -c boot.cat -no-emul-boot -boot-load-size 4 -boot-info-table cdroot
I: -input-charset not specified, using utf-8 (detected in locale settings)
Size of boot image is 4 sectors -> No emulation
 20.52% done, estimate finish Sat Dec 23 05:28:23 2017
 40.98% done, estimate finish Sat Dec 23 05:28:23 2017
 61.50% done, estimate finish Sat Dec 23 05:28:23 2017
 81.96% done, estimate finish Sat Dec 23 05:28:23 2017
Total translation table size: 2048
Total rockridge attributes bytes: 0
Total directory bytes: 0
Path table size(bytes): 10
Max brk space used 0
24402 extents written (47 MB)
