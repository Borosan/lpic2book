...
The Socket Statistics \(ss\) command is similar to netstat, in that it is used to display useful network socket information.How ever the netstat command has been deprecated in favor of the faster, more human-readable ss command.
