...
| :--- | :--- | :--- |
| &lt;file system&gt; | /dev/floppy0 | What we want to be mounted |
| &lt;mount point&gt; | /media/floppy or UUID | Where do we wana mount that |
| &lt;type&gt; | ext4 , sw | File System Type |
| &lt;option&gt; | rw, user, noauto, exec, | mounting options, readable, writable |
| &lt;dump&gt; | 0 or 1 | should take dump after reboot? |
| &lt;pass&gt; | 0 or 1 or 2 , ... | should be checked with fsck? after how many reboots? |
