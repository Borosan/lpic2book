...
Grub2 is more enhanced than legacy grab and if boot problems occur, grub might left system in different states.[^2]
...
[^2]: [Grub2 Troubleshooting](https://help.ubuntu.com/community/Grub2/Troubleshooting)
