...
#### dmesg
 ...
 In LPIC1 Course we discussed that during boot process \(when operating system hasn't been started yet\) dmesg logs kernel ring buffer. So we can use dmseg for troubleshooting or trying to obtain information about hardware
