...
Little by little as kernel grows and memories get bigger, 512k wasn't enough. So bzImage come across and if you have more that 512k zImage, is called "Big zImage". Nowadays zImage just might be seen in some embedded linux systems and bzImage might used beside other methods of compressing initrd .Keep it for now and we will back to this topic in next lessnons.
