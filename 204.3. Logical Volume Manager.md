...
Some Device Mapper Devices might be created just for the system to do it things. 

We can see how the LVM use Device Mapper to create LVM logical volumes
...
[^2]: [http://man7.org/linux/man-pages/man5/lvm.conf.5.html](http://man7.org/linux/man-pages/man5/lvm.conf.5.html)
