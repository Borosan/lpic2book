...
top command is usefull for monitoring both CPU and RAM. Linux has two Spaces from OS point of view, User space and System space , top command classified process this way :
