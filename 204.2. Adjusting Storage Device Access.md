...
```
root@blackbird:~# hdparm -I /dev/sda
...
```
root@blackbird:~# hdparm -t /dev/sda
...
| hdparm -d 1 /dev/sda | set super blocks backup on , values: 0 or 1 |
...
```
root@blackbird:~# tune2fs -l /dev/sda8 | grep -i reserved 
Reserved block count:     610355
Reserved GDT blocks:      1021
Reserved blocks uid:      0 (user root)
Reserved blocks gid:      0 (group root)

root@blackbird:~# tune2fs -m 6 /dev/sda8
tune2fs 1.42.13 (17-May-2015)
